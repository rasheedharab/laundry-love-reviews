          ...
          <ScrollReveal delay={0.05}>
            <div className="px-5 mt-8">
              <button
                ...
                style={{ background: "hsl(24 18% 10%)" }}
              >
                <div className="absolute top-4 right-4">
                  <Crown className="h-8 w-8 text-amber-400/60" />
                </div>
                <p className="text-[10px] text-white/60 uppercase tracking-widest font-medium mb-1">Exclusive Access</p>
                <p className="text-xl font-display font-bold text-white leading-tight">Premium Club</p>
                <p className="text-xs text-white/75 mt-2 leading-relaxed max-w-[240px]">
                  Unlock priority pickup, exclusive discounts, and complimentary garment care with our membership tiers.
                </p>
                <div className="mt-4 flex items-center gap-3">
                  {["Silver", "Gold", "Platinum"].map((tier) => (
                    <span key={tier} className="text-[10px] font-semibold text-amber-300 uppercase tracking-wider bg-amber-300/15 px-2.5 py-1 rounded-full">
                      {tier}
                    </span>
                  ))}
                </div>
                <div className="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-amber-300 uppercase tracking-wider">
